...
function setupRoutes(app: any) {
  ...
  // PM Service Types
  app.get("/api/pm/service-types", async (req: any, res: any) => {
    try {
  ...
  app.post("/api/pm/service-types", async (req: any, res: any) => {
    try {
  ...
  app.put("/api/pm/service-types/:id", async (req: any, res: any) => {
    try {
  ...
  app.get("/api/pm/interval-settings", async (req: any, res: any) => {
    try {
  ...
  app.post("/api/pm/interval-settings", async (req: any, res: any) => {
    try {
  ...
  app.put("/api/pm/interval-settings/:id", async (req: any, res: any) => {
    try {
  ...
  // PM Dashboard Stats
  app.get("/api/pm/stats", async (req: any, res: any) => {
    try {
  ...
  app.get("/api/pm/schedules", async (req: any, res: any) => {
    try {
      const { status, propertyId, equipmentId } = req.query;
      let schedules;
      if (propertyId) {
        schedules = await storage.getEquipmentPmSchedulesByProperty(propertyId);
      } else if (equipmentId) {
        schedules = await storage.getEquipmentPmSchedulesByEquipment(equipmentId);
      } else {
        schedules = await storage.getEquipmentPmSchedules(status);
      }
      res.json(schedules);
    } catch (error: any) {
  ...
  app.get("/api/pm/schedules/:id", async (req: any, res: any) => {
    try {
  ...
  app.post("/api/pm/schedules", async (req: any, res: any) => {
    try {
  ...
  app.put("/api/pm/schedules/:id", async (req: any, res: any) => {
    try {
  ...
  app.delete("/api/pm/schedules/:id", async (req: any, res: any) => {
    try {
  ...
  // PM Service Records
  app.get("/api/pm/records", async (req: any, res: any) => {
    try {
      const { scheduleId, equipmentId, propertyId, limit } = req.query;
      let records: any[] = [];
      if (scheduleId) {
        records = await storage.getPmServiceRecords(scheduleId, limit ? parseInt(limit) : undefined);
      } else if (equipmentId) {
        records = await storage.getPmServiceRecordsByEquipment(equipmentId);
      } else if (propertyId) {
        records = await storage.getPmServiceRecordsByProperty(propertyId);
      }
      res.json(records);
    } catch (error: any) {
  ...
  app.post("/api/pm/records", async (req: any, res: any) => {
    try {
      const record = await storage.createPmServiceRecord(req.body);
      
      // Update the schedule with new last service date and calculate next due date
  ...
  // Seed PM defaults
  app.post("/api/pm/seed", async (req: any, res: any) => {
    try {
